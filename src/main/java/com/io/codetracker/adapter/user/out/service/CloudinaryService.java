...
public class CloudinaryService implements CloudinaryPort{
    ...
    @Override
    public String uploadProfilePicture(byte[] file, String publicId) throws IOException {
    ...
    public String uploadImage(byte[] file, String folder, String publicId) throws IOException {
        ...
        Map<String, Object> uploadResult = (Map<String, Object>) cloudinary.uploader().upload(file, options);
